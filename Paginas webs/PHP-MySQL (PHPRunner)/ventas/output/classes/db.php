...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "ventas_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "categorias", "varname" => "ventas_at_localhost__categorias", "altvarname" => "categorias", "connId" => "ventas_at_localhost", "schema" => "", "connName" => "ventas at localhost");
			$dalTables[$conn->connId][] = array("name" => "productos", "varname" => "ventas_at_localhost__productos", "altvarname" => "productos", "connId" => "ventas_at_localhost", "schema" => "", "connName" => "ventas at localhost");
			$dalTables[$conn->connId][] = array("name" => "usuarios", "varname" => "ventas_at_localhost__usuarios", "altvarname" => "usuarios", "connId" => "ventas_at_localhost", "schema" => "", "connName" => "ventas at localhost");
		}
	}
