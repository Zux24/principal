...
class tDAL
{
	var $tblventas_at_localhost__categorias;
	var $tblventas_at_localhost__productos;
	var $tblventas_at_localhost__usuarios;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "categorias", "varname" => "ventas_at_localhost__categorias", "altvarname" => "categorias", "connId" => "ventas_at_localhost", "schema" => "", "connName" => "ventas at localhost");
		$this->lstTables[] = array("name" => "productos", "varname" => "ventas_at_localhost__productos", "altvarname" => "productos", "connId" => "ventas_at_localhost", "schema" => "", "connName" => "ventas at localhost");
		$this->lstTables[] = array("name" => "usuarios", "varname" => "ventas_at_localhost__usuarios", "altvarname" => "usuarios", "connId" => "ventas_at_localhost", "schema" => "", "connName" => "ventas at localhost");
	}
