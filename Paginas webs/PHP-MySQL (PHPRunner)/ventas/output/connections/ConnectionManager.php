...
class ConnectionManager
{
	...
	{
		return $this->byId( "ventas_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "ventas_at_localhost";
		$data["connName"] = "ventas at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;3306;ventas;;1"; //currently unused

		$this->_connectionsIdByName["ventas at localhost"] = "ventas_at_localhost";
		...
		$data["connInfo"][4] = "ventas";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Port=3306;Database=ventas;OPTION=3";
		// encription set
		...
		$connectionsData["ventas_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["categorias"] = "ventas_at_localhost";
		$connectionsIds["productos"] = "ventas_at_localhost";
		$connectionsIds["usuarios"] = "ventas_at_localhost";
